...
export function AssetIdentifier({
  ...
  if (asset.sourceSystem === "sabium") {
    if (asset.type === "fleet" && asset.incorporation === 0) {
      return <>Frota {asset.baseCode} · #{asset.sourceIdentifier}</>;
    }
    return <>#{asset.sourceIdentifier}</>;
  }
  if (asset.type === "fleet") {
      ...
      <div className="detail-body">
        {activeTab === "summary" ? (
          ...
          <dl className="detail-grid">
            ...
            <div><dt>Valor de aquisição</dt><dd>{formatCurrency(asset.value)}</dd></div>
            <div className="detail-wide"><dt>Descrição padronizada</dt><dd>{asset.brandModel}</dd></div>
            {asset.sourceSystem === "sabium" ? (
              <>
                ...
                <div className="detail-wide"><dt>Descrição original</dt><dd>{asset.sourceDescription}</dd></div>
              </>
            ) : null}
