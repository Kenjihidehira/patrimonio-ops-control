 ...
 *
 * @typedef {"bank"|"cart"|"headset"|"boxes"|"coins"|"broadcast"|"truck"|"chip"|"compass"|"building"} NucleusGlyph
 */
...
const GLIFOS_POR_PALAVRA = [
  ...
  [/atend|customer|experience|\bcx\b|\bsac\b|call|suporte|relacionament/, "headset"],
