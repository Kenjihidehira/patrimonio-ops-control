...
comment on column public.patrimonio_users.is_auditor is
  'Perfil de auditoria: leitura em todos os departamentos ativos e exportacao controlada, sem administracao, escrita ou importacao.';
...
delete from public.patrimonio_department_memberships membership
using public.patrimonio_users app_user
where app_user.identifier = membership.user_identifier
  and app_user.active
  and app_user.is_auditor;
